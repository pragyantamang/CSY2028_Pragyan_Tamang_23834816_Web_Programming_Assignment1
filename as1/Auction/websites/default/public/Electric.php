...
// Fetch only electric car auctions along with their categories and bid amounts
$electricCategoryId = 2; // Replace with the actual categoryId for electric cars
...
');
$stmt->bindParam(':categoryId', $electricCategoryId, PDO::PARAM_INT);
$stmt->execute();
