...
// Fetch only saloon car auctions along with their categories and bid amounts
$saloonCategoryId = 4; // Replace with the actual categoryId for saloon cars
...
');
$stmt->bindParam(':categoryId', $saloonCategoryId, PDO::PARAM_INT);
$stmt->execute();
