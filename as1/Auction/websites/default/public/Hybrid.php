...
// Fetch only Hybrid car auctions along with their categories and bid amounts
$hybridCategoryId = 7; // Replace with the actual categoryId for Hybrid cars
...
');
$stmt->bindParam(':categoryId', $hybridCategoryId, PDO::PARAM_INT);
$stmt->execute();
