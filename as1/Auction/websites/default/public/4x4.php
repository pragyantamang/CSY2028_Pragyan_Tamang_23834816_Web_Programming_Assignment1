...
// Fetch only 4x4 car auctions along with their categories and bid amounts
$fourByFourCategoryId = 5; // Replace with the actual categoryId for 4x4 cars
...
');
$stmt->bindParam(':categoryId', $fourByFourCategoryId, PDO::PARAM_INT);
$stmt->execute();
