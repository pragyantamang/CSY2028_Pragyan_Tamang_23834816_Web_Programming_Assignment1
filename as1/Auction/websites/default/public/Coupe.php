...
// Fetch only coupe car auctions along with their categories and bid amounts
$coupeCategoryId = 3; // Replace with the actual categoryId for coupe cars
...
');
$stmt->bindParam(':categoryId', $coupeCategoryId, PDO::PARAM_INT);
$stmt->execute();
