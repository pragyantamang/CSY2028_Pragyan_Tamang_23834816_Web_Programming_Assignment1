...
// Fetch only sports car auctions along with their categories and bid amounts
$sportsCategoryId = 6; // Replace with the actual categoryId for sports cars
...
');
$stmt->bindParam(':categoryId', $sportsCategoryId, PDO::PARAM_INT);
$stmt->execute();
